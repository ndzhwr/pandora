...
const MainLayout: React.FC<MainLayoutProps> = (props: MainLayoutProps) => {
    ...
    return (
        <>
            ...
            {postId && <div className="fixed  w-screen h-screen rounde-md  md:mb-0 msm:mb-12  msm:p-4 md:p-20 bg-white backdrop-blur-md z-30 top-0 bg-opacity-90 bottom-0 flex  msm:flex-col md:flex-row ">
                {postData && (
                    <>
                        {true && (<img src={'/images/image.jpg'} alt={"Lorem ipsum"} className='object-cover  mr-2 rounded-md ' />)}
                        <div className="  p-4border w-full bg-white rounded-md ">
                            ...
                            <p className="text-xl">The qick brown fox jumps over the lazy dog when money was making man mad The qick brown fox jumps over the lazy dog when money was making man mad</p>
