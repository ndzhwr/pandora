...
const TextInput   :  FC<InputProps> = (props : InputProps) => {
    return (
        <div>
            ...
            <input type={props.type || 'text'} className="px-3 my-2 py-3 text-sm   bg-offwhite bg-opacity-40  w-full" placeholder={props.placeholder} onChange={(e) => props.setStateHook(e.target.value)}/>
        </div>
    )
}
